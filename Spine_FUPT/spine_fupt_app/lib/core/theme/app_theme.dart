// app_theme.dart
// 全局 UI 风格配置 — 轻量简约医疗工具风格（参考豆包App / iOS HIG）
// 使用方式：在 main.dart 中 MaterialApp(theme: AppTheme.light(), darkTheme: AppTheme.dark())
...
class AppColors {
  ...
  static const List<Map<String, Color>> avatarPalette = [
    {'bg': Color(0xFFF2E8FF), 'dot': Color(0xFFC084FC)},
    {'bg': Color(0xFFFEF3C7), 'dot': Color(0xFFF59E0B)},
    {'bg': Color(0xFFDCFCE7), 'dot': Color(0xFF4ADE80)},
    {'bg': Color(0xFFFCE7F3), 'dot': Color(0xFFF472B6)},
    {'bg': Color(0xFFE0F2FE), 'dot': Color(0xFF38BDF8)},
    {'bg': Color(0xFFFFF7ED), 'dot': Color(0xFFFB923C)},
  ];

  // ── 暗色模式 ──
  static const Color darkBgPrimary   = Color(0xFF121212);
  static const Color darkBgSecondary = Color(0xFF1E1E1E);
  static const Color darkBgCard      = Color(0xFF1E1E1E);
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppSpacing.radiusInput),
          borderSide: BorderSide(color: isDark ? const Color(0xFF3A3A3A) : const Color(0xFFD1D5DB), width: 1),
        ),
        ...
        hintStyle: TextStyle(fontSize: 13, fontWeight: FontWeight.w400, color: textHint),
      ),
      ...
      listTileTheme: ListTileThemeData(
        ...
        subtitleTextStyle: TextStyle(
          fontSize: 13, fontWeight: FontWeight.w400, color: textHint,
        ),
      ),
