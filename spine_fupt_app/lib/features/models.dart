class PatientModel {
  ...
  factory PatientModel.fromJson(Map<String, dynamic> json) {
    return PatientModel(
      ...
      lastExamDate: json['last_exam_date'] as String? ?? json['last_followup'] as String?,
...
class ExamModel {
  ...
  factory ExamModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['comments'] is List) {
      cmts = (json['comments'] as List).map((e) => e as Map<String, dynamic>).toList();
    }
    ...
    return ExamModel(
      ...
      spineClassConfidence: (json['spine_class_confidence'] as num?)?.toDouble(),
      ...
      createdAt: json['created_at'] as String? ?? json['upload_date'] as String?,
  ...
  bool get hasAiImage => inferenceImageUrl != null && inferenceImageUrl!.isNotEmpty;
...
class MessageModel {
  ...
  factory MessageModel.fromJson(Map<String, dynamic> json) {
    return MessageModel(
      ...
      payload: json['payload'] is Map ? json['payload'] as Map<String, dynamic> : null,
      createdAt: json['created_at'] as String?,
    );
  }
}
